...
\begin{frame}{El «prodigio» de Bell Labs}
  ...
  \begin{center}
    ...
    \hspace{2.4em}%
    \raisebox{0.5cm}{\usachlogo[0.8cm]{logo-lucent.png}{Lucent Technologies}}%
    \hspace{1.2em}%
...
% =============================================================================
% Sin portadilla de sección aquí (ahorro de tiempo, límite de 10 min):
\renewcommand{\usachpaginaseccion}{}
\section{Conclusiones}
% =============================================================================

\usachdestacado[Conclusiones]{Del fraude artesanal al industrializado, la integridad
