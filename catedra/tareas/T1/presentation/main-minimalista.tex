...
\begin{frame}{El «prodigio» de Bell Labs}
  ...
  \usachdatos{%
    ...
    \begin{minipage}[t]{0.23\linewidth}\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000 \usachdatoi[usachnaranjo]{\faTrophy}{31 años}{candidato al Nobel}\end{minipage}\hfill
  ...
  \end{itemize}
  \note{Un paper cada ocho días y candidato al Nobel a los 31. El prestigio
  de Bell Labs creó una burbuja de confianza ciega.}
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        ...
        \iconitem[usachrojo]{\faUsers}{Coautores sénior}{sin validar datos brutos}
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        ...
        \iconitem[usachnaranjo]{\faUsers}{Resp.~6}{sin corresponsabilidad}
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}{El ruido gemelo}{Revelación y sanciones}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        \iconitem[usachazul]{\faFlask}{Réplicas fallidas}{en cuatro laboratorios}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Comité Beasley}
      \begin{itemize}\usachaire
        \iconitem[usachrojo]{\faExclamationTriangle}{Fraude confirmado}{en al menos 16 papers}
        \iconitem[usachrojo]{\faBan}{Retractaciones}{8 en \emph{Science}, 7 en \emph{Nature}}
...
\begin{frame}{ACM: \emph{paper mills}}{Mercantilización de la autoría}
  ...
  \usachdatos{%
    \begin{minipage}[t]{0.30\linewidth}\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000 \usachdatoi[usachrojo]{\faBan}{>320}{artículos retractados}\end{minipage}\hfill
    \begin{minipage}[t]{0.30\linewidth}\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000 \usachdatoi[usachverde]{\faMoney}{\$500–3.000}{por firma de autoría}\end{minipage}\hfill
    \begin{minipage}[t]{0.30\linewidth}\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000 \usachdatoi[usachazul]{\faClockO}{48 h}{aprobación sin revisión}\end{minipage}}}
  \begin{itemize}\usachaire
    \iconitem[usachrojo]{\faIndustry}{ACM e ICPS}{actas ICICN e ICISS afectadas}
  ...
  de artículos que vendían autorías por miles de dólares.}
\end{frame}
...
\begin{frame}{«Tortured phrases»}{Cómo burlaron los filtros antiplagio}
  ...
  \begin{itemize}\usachaire
    ...
    \iconitem[usachrojo]{\faUsers}{Revisores ficticios}{aprueban en 48 h}
  \end{itemize}
...
\begin{frame}{Minería de texto y sanciones}{La computación desenmascara el fraude}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        \iconitem[usachazul]{\faCode}{Cabanac}{\emph{Problematic Paper Screener}}
        \iconitem[usachazul]{\faSearch}{Labbé y Magazinov}{textos sintéticos}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        ...
        \iconitem[usachrojo]{\faTimesCircleO}{Veto}{3 a 10 años sin publicar}
        \iconitem[usachrojo]{\faDatabase}{\emph{Data poisoning}}{papers falsos en datasets de IA}
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}{Schön vs. ACM}{Dos décadas de fraude}
  \begin{table}
    ...
    \begin{tabularx}{\textwidth}{@{}X X X@{}}
      ...
      Norma rota & FFP + Resp.~4 (bitácoras) & Resp.~6 (autoría) y Resp.~8 (arbitraje) \\
      \bottomrule
    \end{tabularx}
