  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\usachaire
        ...
        \iconitem[usachgris70]{\faUsers}{Coautores sénior}{confiaron sin verificar (debate abierto)}
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{ACM: \emph{paper mills}}{Mercantilización de la autoría}
  ...
  \usachdatos{%
    \begin{minipage}[t]{0.40\linewidth}\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000 \usachdatoi[usachrojo]{\faBan}{>320}{artículos retractados}\end{minipage}}}
  \begin{itemize}\usachaire
...
\begin{frame}{Schön vs. ACM}{Dos décadas de fraude}
  \begin{table}
    ...
    \begin{tabularx}{\textwidth}{@{}X X X@{}}
      ...
      Norma rota & FFP + Resp.~1, 4 (bitácoras); Resp.~6 en debate & Resp.~6 (autoría) y Resp.~8 (arbitraje) \\
      \bottomrule
    \end{tabularx}
